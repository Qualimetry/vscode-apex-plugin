...
public class ParameterCountLimitCheck extends BaseCheck {
    ...
    private static final int DEFAULT_MAX_PARAMS = 7;

    @RuleProperty(
            key = "maxParameters",
            description = "Maximum number of parameters allowed on a method",
            defaultValue = "" + DEFAULT_MAX_PARAMS)
    private int maxParameters = DEFAULT_MAX_PARAMS;
    ...
    public void scan(InputFile file, String content) {
        ...
        while (m.find()) {
            ...
            if (count > maxParameters) {
                ...
                addIssue(line, "Method has " + count + " parameters (max " + maxParameters + ").");
            }
        }
    }
