...
public class ConstantNamingCheck extends BaseCheck {
    ...
    private static final String DEFAULT_FORMAT = "^[A-Z][A-Z0-9_]*(_[A-Z0-9_]+)*[A-Z0-9_]*$";

    @RuleProperty(
            key = "format",
            description = "Regular expression that constant (static final) field names must match",
